...
document.getElementById("update-settings-fb").addEventListener("click", function () {
  var apiUrl = document.getElementById('ff-lead-api').value.trim();
  var isAutoChecked = document.getElementById('fbgl-auto-approve').checked;
